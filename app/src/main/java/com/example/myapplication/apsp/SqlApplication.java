package com.example.myapplication.apsp;

import android.app.Application;
import android.database.sqlite.SQLiteDatabase;

import com.example.myapplication.dp.DaoMaster;
import com.example.myapplication.dp.DaoSession;

public class SqlApplication extends Application {

    private static SqlApplication sInstance;
